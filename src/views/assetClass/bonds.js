  ...
  discussions: [
    {
      ...
      post: {
        title: "Government notifies viability gap funding scheme to support infra projects",
        url: "#"
      },
      body: "Regarding eligibility, it said the project shall be implemented by a private sector company to be..."
    },
    {
      id: 2,
      date: "3 days ago",
      ...
      post: {
        title: "COVID-19 update | ECB gives euro zone another shot in the arm to fight pandemic",
        url: "#"
      },
      body: "The ECB increased the overall size of its Pandemic Emergency Purchase Programme by 500 billion..."
    },
    {
      id: 3,
      date: "5 days ago",
      ...
      post: {
        title: "India's recovery faster than expected; ADB cuts contraction projection to 8% for FY21",
        url: "#"
      },
      body: "Observing that the economy has begun to normalise, the Asian Development Outlook (ADO) Supplement said the ..."
    }
  ]
};
